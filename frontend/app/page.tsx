...
const capabilityCards: ScrollFeatureCard[] = [
  {
    ...
    body: "Streams native Windows counters (CPU, RAM, GPU, Disk I/O) every 2.5s from a local rolling buffer. Completely local and private.",
  ...
  },
  {
    ...
    body: "XGBoost tree ensemble maps multi-core utilization and clock frequencies into estimated wattage dissipation, reporting latency on every request.",
    detail: "R² 0.959 · 4.5% MAPE held-out",
    badge: "Physics AI",
    icon: Cpu,
