...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Raw counters are clipped, normalized, and checked against training bounds — out-of-distribution readings are flagged, never silently trusted.",
    icon: Layers,
    metrics: "13 Model Features · OOD Guard",
  },
  {
    step: "03",
    title: "XGBoost Machine Learning Inference",
    subtitle: "Physics-calibrated CMOS wattage prediction",
    desc: "Our gradient boosted model translates telemetry into estimated wattage draw in milliseconds, reporting per-request latency and feature attributions.",
    icon: Cpu,
    metrics: "R² 0.959 · 4.5% MAPE held-out",
  },
  {
    step: "04",
  ...
  },
  {
    ...
    icon: Lock,
    metrics: "Reversible · User-Approved · Guarded",
  },
  {
    step: "06",
